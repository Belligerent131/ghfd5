...
const HeaderComponent = (props) => {
  ...
  const alters = {
    //type: 'warning',
    //message: 'A quick danger message to test'
  };
...
<Dropdown.Item as={Link} to="/">Vision</Dropdown.Item>*/}
                ...
                <Dropdown.Item as={Link} to="/officials">
                  Elected Officials
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
            <Dropdown as={NavItem}>
              ...
              <Dropdown.Menu>
                <Dropdown.Item as={Link} to="/public/forms">
                  Public Forms
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
      ...
      {alters.type ? <Alert className="header-alert" variant={alters.type}>{alters.message}</Alert> : null}
    </div>
  );
};
